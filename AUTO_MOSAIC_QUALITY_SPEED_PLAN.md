...
- `scripts/verify-face-track-scene-cut-guard.ps1` passed directly after the stronger source-match scene-cut changes: `directRemoved=3`, `weakSourceDirectCandidates=0`, `mediumDirectRemoved=3`, `postCutCandidates=4`, `postCutRemoved=4`, `delayedPostCutCandidates=2`, `noSourcePostCutCandidates=0`, `gradualRemoved=1`, and `mildGradualRemoved=1`.
