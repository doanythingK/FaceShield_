...
- Deletion is still gated by the frame-difference guard, candidate geometry matching, and the `direct<=0.90` cap; this is intended to remove scene-transition residue without treating confidence alone as proof.
