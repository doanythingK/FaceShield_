...
- 2026-05-27 strong carry independence guard: high-confidence post-cut carry-like boxes now need later strong support that has moved or changed scale away from the pre-cut reference before being protected. The synthetic verifier reports `stickyStrongCarryRemoved=5`, `stickyStrongCarryRemovedUnsupportedStrong=5`, and `driftingStrongCarryProtected=3`, so same-position high-confidence blur residue is removed after a confirmed cut while a drifting supported post-cut face can still remain for review.
