...
- 2026-06-02 pseudo-GT person/object confidence gate update: person/object auxiliary rows now must pass `MinPersonObjectConfidence=0.5` before they can populate `personConfidence`, `personUpperOverlap`, `missProbability`, or `auxiliaryPriorityBoost`. Low-confidence person detections stay visible only in the external runner output and no longer raise review priority or imply face evidence.
