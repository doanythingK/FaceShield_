...
- 2026-05-28 pseudo-GT face verification report update: `write-yolo-goal-evidence-report.ps1` now reports `pseudoGtFaceVerificationEvidenceRows` and `pseudoGtClosureFaceVerificationEvidenceRows`, and the goal/readiness verifiers require those report tokens. This keeps high-quality face verification confidence/distance evidence visible through the final report and review-closure CSV without adding that model to the app runtime path.
