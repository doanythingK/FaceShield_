...
- 2026-05-27 scene-carry block extension: the direct carry purge window remains 5 frames, but the final anti-flicker gap-fill block window is now 8 frames. `scripts/verify-yolo-final-mask-cleanup.ps1` passed with `sceneCutCarryFrames=1001,1002,1003,1004,1005,2001,2002,2003,2004,2005,2006,2007,2008` and extended `sceneCutCarryBlockedFrames=1001,1002,1003,1004,1005,1006,1007,1008,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011`, so a confirmed transition can block later gap-fill recreation beyond the shorter purge window without deleting direct YOLO detections outside that purge window.
