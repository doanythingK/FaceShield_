...
Assert-Match "home view binds yolo debug threshold presets" $homeViewText "ItemsSource=""\{Binding YoloDebugThresholdPresets\}""[\s\S]*SelectedItem=""\{Binding SelectedYoloDebugThresholdPreset,\s*Mode=TwoWay\}"""
Assert-Match "home defines recommended false-positive preset ladder" $homeText "0\.12,\s*0\.22,\s*0\.45[\s\S]*0\.12,\s*0\.26,\s*0\.45[\s\S]*0\.12,\s*0\.30,\s*0\.45[\s\S]*0\.12,\s*0\.35,\s*0\.45[\s\S]*0\.16,\s*0\.30,\s*0\.45[\s\S]*0\.20,\s*0\.30,\s*0\.45[\s\S]*0\.24,\s*0\.30,\s*0\.45"
Assert-Match "home applies yolo debug threshold preset atomically" $homeText "OnSelectedYoloDebugThresholdPresetChanged[\s\S]*_isApplyingYoloDebugPreset\s*=\s*true[\s\S]*AutoYoloObjectnessThreshold\s*=\s*value\.Objectness[\s\S]*AutoYoloConfidenceThreshold\s*=\s*value\.Confidence[\s\S]*AutoYoloNmsThreshold\s*=\s*value\.Nms"
