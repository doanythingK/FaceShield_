...
Assert-Match "final mask postprocessor requires area change for strong carry protection" $finalMaskPostProcessorText "hasIndependentAreaChange[\s\S]*options\.StrongCarryProtectionRequiresAreaChange[\s\S]*return hasIndependentAreaChange[\s\S]*StrongCarryProtectionRequiresAreaChange"
