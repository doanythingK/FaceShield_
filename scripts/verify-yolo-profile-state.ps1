...
Assert-Match "automask default yolo path requests precision filtering" $autoMaskGeneratorText "GetFaceFilterSettings\(_options\.FilterProfile,\s*!_options\.EnablePostProcessing\)"
