...
Assert-Match "final mask gap fill blocks known scene cuts" $finalMaskPostProcessorText "CrossesBlockedCut[\s\S]*BlockedCutFramePairs[\s\S]*TryParseFramePair[\s\S]*BlockedCutFramePairs"
