...
Assert-Match "scene cut guard removes track fill" $sceneCutGuardText "DefaultDifferenceThreshold\s*=\s*0\.32[\s\S]*DefaultDirectDifferenceThreshold\s*=\s*0\.42[\s\S]*TryGetNextFrameRawToBuffer[\s\S]*RemoveFaceCandidate"
