...
Assert-Match "workspace purges residual yolo carry masks after scene cuts" $workspaceText "YoloSceneCutCarryPurgeFrames\s*=\s*5[\s\S]*YoloSceneCutCarryPurgeMaxConfidence\s*=\s*0\.90f[\s\S]*RemoveYoloSceneCutCarryRemnants\(yoloCutPairs\)[\s\S]*YoloSceneCutCarryCleanup[\s\S]*IsYoloSceneCutCarryMatch"
