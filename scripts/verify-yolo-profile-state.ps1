...
Assert-Match "workspace final mask summary builds review reasons" $workspaceText "BuildFinalMaskReviewReasons\([\s\S]*short-gap[\s\S]*large-jump-gap[\s\S]*isolated-mask[\s\S]*weak-non-edge[\s\S]*upper-weak[\s\S]*lower-weak[\s\S]*aspect-outlier[\s\S]*tiny-weak[\s\S]*tiny-short[\s\S]*scene-carry-protected"
...
Assert-Match "smoke harness final mask summary builds review reasons" $smokeHarnessText "BuildFinalMaskReviewReasons\([\s\S]*short-gap[\s\S]*large-jump-gap[\s\S]*isolated-mask[\s\S]*weak-non-edge[\s\S]*upper-weak[\s\S]*lower-weak[\s\S]*aspect-outlier[\s\S]*tiny-weak[\s\S]*tiny-short[\s\S]*scene-carry-protected"
