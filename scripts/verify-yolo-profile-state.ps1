...
Assert-Match "final mask cleanup verifies scene-cut carry cleanup behavior" $finalMaskCleanupVerifyText "RemoveSceneCutCarryRemnants[\s\S]*Expected scene-cut carry cleanup to remove weak frames 1001-1005, extended weak frames 1007-1008, and direct-pair frames 2001-2008[\s\S]*Expected scene-cut carry cleanup to report protected strong carry-like frames 1006 and 2009[\s\S]*Expected scene-cut carry cleanup frames to block final gap refill[\s\S]*Expected high-confidence post-cut anchors to be reported as protected carry-like review candidates"
