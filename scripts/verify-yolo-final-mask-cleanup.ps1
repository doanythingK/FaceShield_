...
if (result.RemovedWeakIsolatedFaces != 39)
    throw new InvalidOperationException($"Expected 39 weak/tiny isolated/short/tiny/top-edge/top-edge-large/upper/lower/aspect-cluster faces to be removed, got {result.RemovedWeakIsolatedFaces}.");
