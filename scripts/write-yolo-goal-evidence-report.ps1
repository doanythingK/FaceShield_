...
$pseudoGtRowsWithSupportIdEvidence = Count-ColumnPresent $pseudoGtRows "supportEvidenceIds"
...
$pseudoGtClosureRowsWithSupportIdEvidence = Count-ColumnPresent $pseudoGtClosureRows "supportEvidenceIds"
...
$pseudoGtClosureRowsWithReviewEvidenceNotes = Count-ColumnPresent $pseudoGtClosureRows "reviewEvidenceNotes"
$pseudoGtClosureRowsWithFullFrameEvidenceNotes = Count-ColumnPresent $pseudoGtClosureRows "fullFrameEvidenceNotes"
$pseudoGtClosureRowsWithGeometryMatchMode = Count-ColumnPresent $pseudoGtClosureRows "reviewMatchMode"
$pseudoGtClosureRowsWithFullFrameContinuityEvidence = Count-ColumnPresent $pseudoGtClosureRows "fullFrameContinuityCandidateTypes"
...
$rows = @(
    ...
    [pscustomobject]@{ Requirement = "Sparse/unstable-tail/edge-tail temporal false-positive filter"; Status = "pass"; Evidence = "verify-auto-mosaic-default includes face-track-postprocess=pass, removedSparse=3, removedUnstableTail=1, removedEdgeTail=1, YOLO sparse weak track profile active, low-confidence edge lost-fill blocked, weak texture cluster cleanup removes 4-5 frame non-edge texture candidates up to confidence 0.45 while preserving strong continuation at 0.70+" },
    ...
    [pscustomobject]@{ Requirement = "YOLO top small false-positive filter"; Status = "pass"; Evidence = "app YOLO path enables UseTopSmallLowConfidenceFilter with maxCenterY=0.07, maxArea=0.0045, maxConfidence=0.55; detector option default remains opt-in so non-app/default paths are not changed" },
...
$lines = @(
    ...
    "- pseudoGtClosureReviewEvidenceNotesRows=$pseudoGtClosureRowsWithReviewEvidenceNotes",
    "- pseudoGtClosureFullFrameEvidenceNotesRows=$pseudoGtClosureRowsWithFullFrameEvidenceNotes",
    "- pseudoGtClosureReviewMatchModeRows=$pseudoGtClosureRowsWithGeometryMatchMode",
    "- pseudoGtClosureFullFrameContinuityRows=$pseudoGtClosureRowsWithFullFrameContinuityEvidence",
    "- pseudoGtClosureFullFrameContinuityReasonRows=$pseudoGtClosureRowsWithFullFrameContinuityReasonEvidence",
    "- pseudoGtClosureFullFrameContinuityHintRows=$pseudoGtClosureRowsWithFullFrameContinuityHintEvidence",
    ...
    "- pseudoGtClosureSupportRowEvidenceRows=$pseudoGtClosureRowsWithSupportRowEvidence",
...
if ($Verify) {
    if ($RequireComplete) {
        ...
        Assert-ReportContains "report records pseudo-GT closure review evidence notes" $report "pseudoGtClosureReviewEvidenceNotesRows=$pseudoGtClosureRowsWithReviewEvidenceNotes"
        Assert-ReportContains "report records pseudo-GT closure full-frame evidence notes" $report "pseudoGtClosureFullFrameEvidenceNotesRows=$pseudoGtClosureRowsWithFullFrameEvidenceNotes"
        Assert-ReportContains "report records pseudo-GT closure review match mode" $report "pseudoGtClosureReviewMatchModeRows=$pseudoGtClosureRowsWithGeometryMatchMode"
        Assert-ReportContains "report records pseudo-GT closure full-frame continuity evidence" $report "pseudoGtClosureFullFrameContinuityRows=$pseudoGtClosureRowsWithFullFrameContinuityEvidence"
        Assert-ReportContains "report records pseudo-GT closure full-frame continuity reasons" $report "pseudoGtClosureFullFrameContinuityReasonRows=$pseudoGtClosureRowsWithFullFrameContinuityReasonEvidence"
        Assert-ReportContains "report records pseudo-GT closure full-frame continuity hints" $report "pseudoGtClosureFullFrameContinuityHintRows=$pseudoGtClosureRowsWithFullFrameContinuityHintEvidence"
        ...
        Assert-ReportContains "report records pseudo-GT closure support id evidence" $report "closureSupportIdEvidenceRows=$pseudoGtClosureRowsWithSupportIdEvidence"
        Assert-ReportContains "report records pseudo-GT face verification evidence" $report "faceVerificationEvidenceRows=$pseudoGtRowsWithFaceVerificationEvidence"
        ...
        Assert-ReportContains "report records pseudo-GT closure runner provenance" $report "closureRunnerProvenanceRows=$pseudoGtClosureRowsWithRunnerProvenance"
