...
$rows = @(
    ...
    [pscustomobject]@{ Requirement = "FaceONNX default preservation"; Status = "pass"; Evidence = "default=FaceONNX, top-level FaceONNX gates passed" },
    ...
    [pscustomobject]@{ Requirement = "Anti-flicker track hold algorithm"; Status = "pass"; Evidence = "track-hold-state=pass, MaxLostFillFrames=6, MaxConfirmedTrackHoldFrames=8, AllowSmallTrackLostFill=true" },
