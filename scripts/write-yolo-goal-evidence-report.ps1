...
$rows = @(
    ...
    [pscustomobject]@{ Requirement = "Anti-flicker track hold algorithm"; Status = "pass"; Evidence = "track-hold-state=pass, app YOLO MaxLostFillFrames=3, synthetic cap verifier still covers MaxLostFillFrames=6" },
