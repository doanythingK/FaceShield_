...
Assert-Contains "summary records final mask review reasons" $summaryText "reviewRequired=True[\s\S]*reviewReasons=short-gap,large-jump-gap,isolated-mask,weak-non-edge,upper-weak,lower-weak,aspect-outlier,tiny-weak,tiny-short,scene-carry-protected"
