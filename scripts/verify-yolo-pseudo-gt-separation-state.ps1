...
$pseudoGtReviewVisualPackage = Read-RequiredFile "scripts/new-yolo-pseudo-gt-review-visual-package.ps1"
...
Assert-Contains "pseudo-GT visual package records test-only boundary" $pseudoGtReviewVisualPackage "test-only visual review evidence"
Assert-Contains "pseudo-GT visual package keeps final labels human-owned" $pseudoGtReviewVisualPackage "does not finalize face/nonface/miss labels"
Assert-Contains "pseudo-GT visual package keeps review CSV ownership" $pseudoGtReviewVisualPackage "final face/nonface/miss labels remain review CSV-owned"
