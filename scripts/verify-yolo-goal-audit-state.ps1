...
Assert-Contains "anti flicker yolo confirmed hold cap recorded" $plan "MaxConfirmedTrackHoldFrames=8"
...
Assert-Contains "track hold internal gap frames recorded" $plan "gapFrames=13,14,15,16,17,18,19"
...
Assert-Contains "evidence report writer records same-size carry removal evidence" $goalEvidenceReportWriter "driftingStrongCarryRemoved=5"
Assert-Contains "evidence report writer records scale-changed carry protection evidence" $goalEvidenceReportWriter "areaChangedStrongCarryProtected=3"
