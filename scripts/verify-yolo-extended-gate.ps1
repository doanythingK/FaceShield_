...
function Assert-Match {
    ...
    Write-Host "[YoloExtendedGateVerify] pass $Name"
}
...
Write-Host "[YoloExtendedGateVerify] start extended-gate"
...
if ($exitCode -ne 2) {
    throw "extended-gate expected exit code 2 but got $exitCode"
}
...
Write-Host "[YoloExtendedGateVerify] all requested checks passed"
