...
Assert-Match "runner supports pseudo gt tile external command" $runner 'PseudoGtTileExternalCommand[\s\S]*-PseudoGtTileExternalCommand[\s\S]*PseudoGtTileExternalOutputCsv[\s\S]*-PseudoGtTileExternalOutputCsv'
...
Assert-Match "guide documents integrated pseudo gt tile external runner" $guide 'WithPseudoGtTileInput[\s\S]*PseudoGtTileExternalCommand[\s\S]*PseudoGtTileExternalOutputCsv[\s\S]*tile-face\.csv'
