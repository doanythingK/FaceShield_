    ...
    bool yoloDebugDump)
{
    ...
    if (useYolo)
    {
        ...
        var postSceneBlockedFaces = cleanupBlockedFaces
            ...
            .ToArray();
        Console.WriteLine($"[SmokeYoloFinalMaskPostSceneCleanup] label={label}, removedWeakIsolated={postSceneCleanup.RemovedWeakIsolatedFaces}, removedWeakUnsupported={postSceneCleanup.RemovedWeakUnsupportedFaces}, removedMediumUnsupported={postSceneCleanup.RemovedMediumUnsupportedFaces}, removedWeakShortClusters={postSceneCleanup.RemovedWeakShortClusterFaces}, removedWeakTinyClusters={postSceneCleanup.RemovedWeakTinyClusterFaces}, removedTinyShortClusters={postSceneCleanup.RemovedTinyShortClusterFaces}, removedTinyIsolated={postSceneCleanup.RemovedTinyIsolatedFaces}, removedTopEdgeWeakClusters={postSceneCleanup.RemovedTopEdgeWeakClusterFaces}, removedTopEdgeLargeDuplicates={postSceneCleanup.RemovedTopEdgeLargeDuplicateFaces}, removedUpperWeakClusters={postSceneCleanup.RemovedUpperWeakClusterFaces}, removedLowerWeakClusters={postSceneCleanup.RemovedLowerWeakClusterFaces}, removedAspectOutliers={postSceneCleanup.RemovedAspectOutlierClusterFaces}, removedFrames={FormatFrames(postSceneCleanup.RemovedFrameIndices)}");
