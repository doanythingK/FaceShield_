    ...
    bool yoloDebugDump)
{
    ...
    const float yoloSceneCutStrongCarryProbeMaxConfidence = 1.0f;
    const float yoloSceneCutStrongCarryProbeMinConfidence = 0.78f;
    const float yoloSceneCutStrongCarryProbeMinSourceConfidence = 0.58f;
    const double yoloSceneCutDifferenceThreshold = 0.15;
    const double yoloSceneCutDirectDifferenceThreshold = 0.20;
    const int yoloSceneCutDirectDifferenceMaxCandidates = 240;
    const int yoloSceneCutCarryPurgeFrames = 15;
    const int yoloSceneCutCarryBlockFrames = 15;
    ...
    if (useYolo)
    {
        ...
        var postSceneBlockedFaces = cleanupBlockedFaces
            ...
            .ToArray();
        Console.WriteLine($"[SmokeYoloFinalMaskPostSceneCleanup] label={label}, removedWeakIsolated={postSceneCleanup.RemovedWeakIsolatedFaces}, removedWeakUnsupported={postSceneCleanup.RemovedWeakUnsupportedFaces}, removedMediumUnsupported={postSceneCleanup.RemovedMediumUnsupportedFaces}, removedWeakShortClusters={postSceneCleanup.RemovedWeakShortClusterFaces}, removedWeakTextureClusters={postSceneCleanup.RemovedWeakTextureClusterFaces}, removedWeakTinyClusters={postSceneCleanup.RemovedWeakTinyClusterFaces}, removedTinyShortClusters={postSceneCleanup.RemovedTinyShortClusterFaces}, removedTinyIsolated={postSceneCleanup.RemovedTinyIsolatedFaces}, removedTopEdgeWeakClusters={postSceneCleanup.RemovedTopEdgeWeakClusterFaces}, removedTopEdgeLargeDuplicates={postSceneCleanup.RemovedTopEdgeLargeDuplicateFaces}, removedUpperWeakClusters={postSceneCleanup.RemovedUpperWeakClusterFaces}, removedLowerWeakClusters={postSceneCleanup.RemovedLowerWeakClusterFaces}, removedAspectOutliers={postSceneCleanup.RemovedAspectOutlierClusterFaces}, removedFrames={FormatFrames(postSceneCleanup.RemovedFrameIndices)}");
