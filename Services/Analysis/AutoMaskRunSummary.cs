...
namespace FaceShield.Services.Analysis
{
        ...
        string? DetectorName)
    {
        ...
        public bool ReachedDecoderEof { get; init; } = false;
        public bool DecodeCancelled { get; init; } = false;
        public string DecodeError { get; init; } = "none";
