...
- 후보별 `baseFaceConfidence`, `tileFaceConfidence`, `tileSupportCount`, `faceVerificationConfidence`, `faceVerificationDistance`, `personConfidence`, `personUpperOverlap`, `personObjectClass`, `supportFrameCount`, `supportRowCount`, `bestIou`, `centerDistanceRatio`, `areaChangeRatio`, `fpProbability`, `missProbability`, `pseudoGtReason`을 evidence log/CSV에 남긴다.
