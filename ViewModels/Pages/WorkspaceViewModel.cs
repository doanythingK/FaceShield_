...
namespace FaceShield.ViewModels.Pages
{
    public partial class WorkspaceViewModel : ViewModelBase
    {
            ...
            IReadOnlyList<string>? autoHybridDisableReasons)
        {
            ...
            if (packetDropRate > 0.001)
            {
                reviewRiskScore++;
                riskReasons.Add("packet-drop-rate");
            }
